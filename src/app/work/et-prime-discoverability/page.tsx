...
const EtPrimeDiscoverabilityPage = () => (
  <main className="min-h-screen py-12">
    ...
    <article className="space-y-8">
      <figure className="relative w-full aspect-video rounded-2xl overflow-hidden">
        <Image
          src="/images/et-prime.jpg"
          alt="Feature Discoverability - ET Prime"
          fill
      ...
      <header>
        <h1 className="text-2xl sm:text-3xl font-semibold">
          Feature Discoverability - ET Prime
        </h1>
...
export default EtPrimeDiscoverabilityPage;
